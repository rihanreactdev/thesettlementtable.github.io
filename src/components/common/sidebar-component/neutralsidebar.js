...
import { NEWMENUITEMS } from '../../../constant/menu';
...
const NewSidebar = (props) => {
    ...
    const [mainmenu, setMainMenu] = useState(NEWMENUITEMS);
...
export default translate(NewSidebar);
